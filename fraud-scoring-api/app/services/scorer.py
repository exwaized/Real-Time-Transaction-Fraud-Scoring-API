...
class Scorer:
    ...
    def score(self, amount, hour, day_of_week, merchant_category, velocity):
        ...
        t0 = time.perf_counter()   # ← start timer HERE, after scaling
...
scorer = Scorer()
# Alias for backward compatibility with score.py import
fraud_scorer = scorer
